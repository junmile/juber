...
export interface Query {
  ...
  GetMyProfile: GetMyProfileResponse;
  GetNearbyDrivers: GetNearbyDriversResponse;
  RegistrationCheck: RegistrationCheckResponse;
}
...
export interface RegistrationCheckQueryArgs {
  type: string;
